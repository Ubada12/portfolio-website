...
import { SOCIAL_LINKS_WITH_EMAIL, PERSONAL_INFO } from "@/constants/personal"
import { FOOTER_CONTENT, TYPEWRITER_WORDS } from "@/constants/footer"
        ...
        <div ref={ctaRef} className="px-4 py-16 sm:py-24 md:py-32 sm:px-6">
          <div className="mx-auto max-w-5xl text-center">
            ...
            >
              ...
              <span className="text-sm text-primary font-medium">{FOOTER_CONTENT.availabilityBadge}</span>
            </motion.div>
            ...
            >
              <span className="block">{FOOTER_CONTENT.headlinePrefix}</span>
              ...
              <span className="block mt-2">{FOOTER_CONTENT.headlineSuffix}</span>
            </motion.h2>
            ...
            >
              ...
              >
                ...
                <span className="relative">{FOOTER_CONTENT.ctaText}</span>
        ...
        <div className="px-4 py-8 sm:py-12 sm:px-6">
          <div className="mx-auto max-w-7xl">
            <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
              ...
              >
                <div className="font-heading text-xl font-bold text-foreground mb-1">{PERSONAL_INFO.name}</div>
                <div className="text-sm text-muted-foreground">{PERSONAL_INFO.role}</div>
              </motion.div>
              ...
              >
                {SOCIAL_LINKS_WITH_EMAIL.map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
                    target="_blank"
              ...
              >
                <div className="text-sm text-muted-foreground">© {new Date().getFullYear()} {FOOTER_CONTENT.copyright}</div>
                <div className="text-xs text-muted-foreground/60 mt-1">{FOOTER_CONTENT.tagline}</div>
              </motion.div>
            </div>
          </div>
        </div>
