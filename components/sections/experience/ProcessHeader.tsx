 ...
 *
 * Sticky top bar shown while the Engineering Process section is in view.
 * Displays the current step label, a rotating sparkle icon, and a
 * step-counter with animated progress bar. Colors transition to match
