 ...
 *
 * Bottom progress strip shown while the Engineering Process section is
 * in view. Renders a row of step circles connected by animated
 * connector bars, with pulse rings on the active step. Also shows a
 * truncated description line on sm+ screens.
 */
