...
import { LOGO_TEXT, RESUME_PATH } from "@/constants/personal"
...
function NavigationComponent() {
  ...
  const navItems = useMemo(
    ...
    [activeSection, hoveredItem, handleScrollToSection]
  )
    ...
    <>
      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between">
          <motion.a href="#" className="relative group" aria-label={`Home - ${LOGO_TEXT}`} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
